	...
	<div class="galaxy">
		<ol class="system">
			...
			<li class="saturn"><i><img alt="Saturn" width="50%" height="50%" src="/assets/img/img-scale-saturn.png" ></i></li>
			<li class="uranus"><i><img alt="Uranus" width="50%" height="50%" src="/assets/img/img-scale-uranus.png" ></i></li>
			<li class="neptune"><i><img alt="Neptune" width="50%" height="50%" src="/assets/img/img-scale-neptune.png" ></i></li>
		</ol>
	</div>